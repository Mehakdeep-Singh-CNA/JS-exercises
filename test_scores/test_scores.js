...
// new code  to display scores
document.getElementById('score_1').innerHTML =  `Score 1 = ${score1}`
document.getElementById('score_2').innerHTML =  `Score 2 = ${score2}`
document.getElementById('score_3').innerHTML =  `Score 3 = ${score3}`
